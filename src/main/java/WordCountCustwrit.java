...
public class WordCountCustwrit {
	public static class TokenizerMapper extends Mapper<IntJon, TextJon, TextJon, IntJon> {
		private final static IntJon one = new IntJon(1);
		private TextJon word = new TextJon();
		
		public void map(IntJon key, TextJon value, Context context ) throws IOException, InterruptedException {
...
//		job.setOutputFormatClass(XMLOutputFormat.c lass);
